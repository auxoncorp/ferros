    ...
    fn from(info_and_sender: (MessageInfo, Badge)) -> Self {
        ...
        match info.label() {
            ...
            UNKNOWN_SYSCALL => Fault::UnknownSyscall(UnknownSyscall {
                sender,
                x0: buffer.msg[seL4_UnknownSyscall_X0 as usize],
                x1: buffer.msg[seL4_UnknownSyscall_X1 as usize],
                x2: buffer.msg[seL4_UnknownSyscall_X2 as usize],
                x3: buffer.msg[seL4_UnknownSyscall_X3 as usize],
                x4: buffer.msg[seL4_UnknownSyscall_X4 as usize],
                x5: buffer.msg[seL4_UnknownSyscall_X5 as usize],
                x6: buffer.msg[seL4_UnknownSyscall_X6 as usize],
                x7: buffer.msg[seL4_UnknownSyscall_X7 as usize],
                ...
                saved_program_status_register: buffer.msg[seL4_UnknownSyscall_SPSR as usize],
            ...
            USER_EXCEPTION => Fault::UserException(UserException {
                ...
                saved_program_status_register: buffer.msg[seL4_UserException_SPSR as usize],
