...
pub struct Resources {
    ...
    pub(super) reserved_for_scratch: ReservedRegion<crate::userland::process::StackBitSize>,
...
pub struct TestResourceRefs<'t> {
    ...
    pub(super) scratch: ScratchRegion<'t, 't, crate::userland::process::StackBitSize>,
