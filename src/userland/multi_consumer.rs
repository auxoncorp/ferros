...
use crate::cap::{
    ...
    DirectRetype, IRQControl, IRQError, IRQHandler, LocalCNode, LocalCNodeSlot, LocalCNodeSlots,
    LocalCap, Notification, PhantomCap, Untyped,
};
...
pub struct ProducerSetup<T, QLen: Unsigned> {
    shared_region: UnmappedMemoryRegion<PageBits, shared_status::Shared, memory_kind::General>,
    queue_badge: Badge,
...
>(
    ...
    (
        UnmappedMemoryRegion<PageBits, shared_status::Shared, memory_kind::General>,
        MappedMemoryRegion<PageBits, shared_status::Shared, memory_kind::General>,
    ),
    MultiConsumerError,
>
where
